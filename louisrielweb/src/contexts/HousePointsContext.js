...
const WS_PATCH_HOUSE_POINTS = 'ws_patch_house_points'
...
const fetchPoints = dispatch => async () => {
    ...
    let [sumPoints] = response.data
    if(!sumPoints){
        sumPoints = { eagle: 0, bear: 0, turtle: 0, wolf: 0}
    }
...
export const { Context, Provider } = createDataContext(
    ...
    { sumEntries:{ wolf:0, bear:0, eagle: 0, turtle:0 }, loaded: false, 
    entries:{},
    entryLoaded:false,
